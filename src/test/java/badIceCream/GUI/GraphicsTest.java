...
public class GraphicsTest {
    ...
    public void setUp() throws IOException {
        ...
        when(gui.createScreen(gui.createTerminal())).thenReturn(screen);
    ...
    public void drawIceCream(){
        ...
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '7', "#48DEFF");
        graphics.drawIceCream(position, GUI.ACTION.UP, false);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '7', "#FFFFFF");
        graphics.drawIceCream(position, GUI.ACTION.DOWN, true);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '8', "#48DEFF");
        graphics.drawIceCream(position, GUI.ACTION.DOWN, false);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '8', "#FFFFFF");
        graphics.drawIceCream(position, GUI.ACTION.LEFT, true);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), ':', "#48DEFF");
        graphics.drawIceCream(position, GUI.ACTION.LEFT, false);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), ':', "#FFFFFF");
        graphics.drawIceCream(position, GUI.ACTION.RIGHT, true);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '9', "#48DEFF");
        graphics.drawIceCream(position, GUI.ACTION.RIGHT, false);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '9', "#FFFFFF");
    }
    @Test
    public void drawStoneWall(){
        graphics.drawStoneWall(position);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'G', "#696969");
    }
    @Test
    public void drawIceWall(){
        graphics.drawIceWall(position,1);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'F', "#87CEFA");
        graphics.drawIceWall(position,3);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'f', "#87CEFA");
        graphics.drawIceWall(position,4);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'h', "#87CEFA");
        graphics.drawIceWall(position,5);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'g', "#87CEFA");
        graphics.drawIceWall(position,6);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'i', "#87CEFA");
        graphics.drawIceWall(position,7);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'e', "#87CEFA");
        graphics.drawIceWall(position,8);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'k', "#87CEFA");
        graphics.drawIceWall(position,9);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'l', "#87CEFA");
        graphics.drawIceWall(position,10);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'n', "#87CEFA");
        graphics.drawIceWall(position,11);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'm', "#87CEFA");
    }
    @Test
    public void drawDefaultMonster() {
        graphics.drawDefaultMonster(position, GUI.ACTION.UP);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '4', "#00FF00");
        graphics.drawDefaultMonster(position, GUI.ACTION.LEFT);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '~', "#00FF00");
        graphics.drawDefaultMonster(position, GUI.ACTION.RIGHT);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'È', "#00FF00");
        graphics.drawDefaultMonster(position, GUI.ACTION.DOWN);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'Y', "#00FF00");
    }
    @Test
    public void drawJumperMonster() {
        graphics.drawJumperMonster(position, GUI.ACTION.UP);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '/', "#FF3333");
        graphics.drawJumperMonster(position, GUI.ACTION.LEFT);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'y', "#FF3333");
        graphics.drawJumperMonster(position, GUI.ACTION.RIGHT);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'è', "#FF3333");
        graphics.drawJumperMonster(position, GUI.ACTION.DOWN);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'T', "#FF3333");
    }
    @Test
    public void drawRunnerMonster() {
        graphics.drawRunnerMonster(position, GUI.ACTION.UP, true);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '3', "#FF0000");
        graphics.drawRunnerMonster(position, GUI.ACTION.UP, false);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '1', "#FFFF66");
        graphics.drawRunnerMonster(position, GUI.ACTION.LEFT, true);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'X', "#FF0000");
        graphics.drawRunnerMonster(position, GUI.ACTION.LEFT, false);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'W', "#FFFF66");
        graphics.drawRunnerMonster(position, GUI.ACTION.RIGHT, true);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '}', "#FF0000");
        graphics.drawRunnerMonster(position, GUI.ACTION.RIGHT, false);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '2', "#FFFF66");
        graphics.drawRunnerMonster(position, GUI.ACTION.DOWN, true);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '|', "#FF0000");
        graphics.drawRunnerMonster(position, GUI.ACTION.DOWN, false);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'V', "#FFFF66");
    }
    @Test
    public void drawWallBreakerMonster() {
        graphics.drawWallBreakerMonster(position, GUI.ACTION.UP);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '0', "#FF99FF");
        graphics.drawWallBreakerMonster(position, GUI.ACTION.LEFT);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'é', "#FF99FF");
        graphics.drawWallBreakerMonster(position, GUI.ACTION.RIGHT);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'z', "#FF99FF");
        graphics.drawWallBreakerMonster(position, GUI.ACTION.DOWN);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'U', "#FF99FF");
    }
    @Test
    ...
    public void drawBananaFruit() {
        ...
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'a', "#FFFF00");
    }
    @Test
    public void drawPineappleFruit() {
        graphics.drawPineappleFruit(position);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '^', "#FFFF66");
    }
    @Test
    ...
    public void drawStrawberryFruit() {
        ...
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '_', "#FF0000");
    }
    @Test
    public void drawHotFloor() {
        graphics.drawHotFloor(position,1);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'w', "#e14750");
        graphics.drawHotFloor(position,2);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'd', "#e14750");
        graphics.drawHotFloor(position,3);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'c', "#e14750");
        graphics.drawHotFloor(position,4);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'x', "#e14750");
        graphics.drawHotFloor(position,5);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), '%', "#e14750");
        ...
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'S', "#e14750");
        graphics.drawHotFloor(position,16);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'R', "#e14750");
        ...
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'B', "#e14750");
        graphics.drawHotFloor(position,25);
        verify(graphics,times(1)).drawCharacter(position.getX(), position.getY(), 'A', "#e14750");
