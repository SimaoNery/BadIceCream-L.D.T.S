...
public class GraphicsTest {
    ...
    public void drawHotFloor() {
        ...
        verify(gui,times(1)).drawCharacter(position.getX(), position.getY(), 'w', "#e14750");
        graphics.drawHotFloor(position,2);
        verify(gui,times(1)).drawCharacter(position.getX(), position.getY(), 'd', "#e14750");
        graphics.drawHotFloor(position,3);
        verify(gui,times(1)).drawCharacter(position.getX(), position.getY(), 'c', "#e14750");
        graphics.drawHotFloor(position,4);
        verify(gui,times(1)).drawCharacter(position.getX(), position.getY(), 'x', "#e14750");
        graphics.drawHotFloor(position,5);
        verify(gui,times(1)).drawCharacter(position.getX(), position.getY(), '%', "#e14750");
        ...
        verify(gui,times(1)).drawCharacter(position.getX(), position.getY(), 'S', "#e14750");
        graphics.drawHotFloor(position,16);
        verify(gui,times(1)).drawCharacter(position.getX(), position.getY(), 'R', "#e14750");
        ...
        verify(gui,times(1)).drawCharacter(position.getX(), position.getY(), 'B', "#e14750");
        graphics.drawHotFloor(position,25);
        verify(gui,times(1)).drawCharacter(position.getX(), position.getY(), 'A', "#e14750");
